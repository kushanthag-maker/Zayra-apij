...
//   1. MongoDB (built-in default URI, or MONGODB_URI env override) → permanent
//   2. Upstash Redis (KV_REST_API_* )   → permanent
//   3. in-memory (+ JSON file locally)  → development only, resets on Vercel
// Always prefer MongoDB when URI is available (default is baked in).
process.env.MONGODB_URI = process.env.MONGODB_URI || 'mongodb+srv://heshancamika_db_user:XM8EiSj9zHJLeMuG@cluster0.nimdgb1.mongodb.net/?appName=Cluster0';
